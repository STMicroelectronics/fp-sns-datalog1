...
#define BLE_CM_SPI_EXTI_PORT                        GPIOD
#define BLE_CM_SPI_EXTI_PIN                         GPIO_PIN_4
#define BLE_CM_SPI_EXTI_IRQn                        EXTI4_IRQn

#define BLE_CM_SPI_CS_PORT                          GPIOD
#define BLE_CM_SPI_CS_PIN                           GPIO_PIN_0
